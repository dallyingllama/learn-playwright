...
const config = {
  menu: sectionMetadata.elements.homeCard,
  message: SECTION_LANDING_MESSAGE,
  url: sectionMetadata.elements.url,
};

export class ElementsPage extends BasePage implements NavigablePage {
  readonly goto;
